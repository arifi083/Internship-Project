  ...
  <!-- ==================== skip_brand_1 PRODUCTS  brandwise product ======================= -->
   ...
   <!-- ==============================================End skip_brand_1  : END ============================================== --> 
        ...
        <section class="section latest-blog outer-bottom-vs wow fadeInUp">
         ...
         <h3 class="name"><a href="#">@if(session()->get('language') == 'hindi') {{ $blog->post_title_hin }}  
        @else {{ $blog->post_title_en }} @endif</a></h3>

        <span class="text-info"> {{ Carbon\Carbon::parse($blog->created_at)->diffForHumans()  }}</span>

        <p class="text">@if(session()->get('language') == 'hindi') {!! Str::limit($blog->post_details_hin, 100 ) !!}  
         @else {!! Str::limit($blog->post_details_en, 100 ) !!}
         @endif</p>
